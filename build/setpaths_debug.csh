...
setenv PYTHONPATH "`libtbx.path_utility prepend LIBTBX_TMPVAL '$LIBTBX_BUILD/../modules/cctbx_project:$LIBTBX_BUILD/../modules:$LIBTBX_BUILD/lib:$LIBTBX_BUILD/../base/lib/site-python:$LIBTBX_BUILD/../base/lib/python2.7/site-packages' < /dev/null`"
...
setenv LD_LIBRARY_PATH "`libtbx.path_utility prepend LIBTBX_TMPVAL '$LIBTBX_BUILD/lib:$LIBTBX_BUILD/../base/lib64:$LIBTBX_BUILD/../base/lib' < /dev/null`"
